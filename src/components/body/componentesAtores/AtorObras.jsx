...
export const ComponentActorWorks = ({ value }) => {
    const sortedValue = value.sort((a,b) => b.vote_average - a.vote_average);
        ...
        <section className="max-w-screen-xl mx-auto">
            ...
            <div className="flex justify-start overflow-x-auto py-5 text-branco">
                {sortedValue.length > 0 ? (
                    <div className='gap-5 max-sm:flex max-sm:flex-col max-md:flex max-md:flex-col grid max-lg:grid-cols-3 grid-cols-4'>
                        {sortedValue.map((movie, index) => (
